    ...
    <div className={styles.modalOverlay} role="dialog" aria-modal="true" aria-label="Modifier le profil">
      <div className={styles.modal} ref={ref}>
        ...
        <div className={styles.modalActions}>
          <button
            onClick={onClose}
            style={{ padding: '10px 12px', borderRadius: 10, border: '1px solid rgba(0,0,0,.1)', background: '#fff' }}
          >
            Annuler
          </button>
          <button
            onClick={() => onSave?.({ ...initial, displayName, bio, avatarUrl, flags, convictions })}
            style={{ padding: '10px 12px', borderRadius: 10, border: '1px solid rgba(0,0,0,.1)', background: '#111', color: '#fff' }}
          >
            Enregistrer
          </button>
        </div>
